        ...
        if( $this->respuesta['msg']=='ok' ){
            if($accion=='nuevo'){
                return $this->db->consultas(
                    ...
                    $this->datos['idMatricula'], $this->datos['alumno'], $this->datos['fecha'], $this->datos['pago'], $this->datos['imgAlumno']
                );
            }else if($accion=='modificar'){
                return $this->db->consultas(
                    'UPDATE matriculas SET alumno=?, fecha=?, pago=?, imgAlumno=? WHERE idMatricula=?',
                    $this->datos['alumno'], $this->datos['fecha'], $this->datos['pago'], $this->datos['imgAlumno'], $this->datos['idMatricula']
                );
